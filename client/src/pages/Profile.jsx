    ...
    >
      ...
      <header className="max-w-7xl mx-auto mb-12">
        <button
          ...
          className={`
            ...
            tracking-widest transition-colors mb-6
      ...
      <main className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="bg-gradient-to-br from-indigo-600 to-violet-700 rounded-[45px] p-10 text-white shadow-2xl shadow-indigo-500/20 text-center relative overflow-hidden">
            ...
            <div className="grid grid-cols-3 gap-4 mb-10">
              {profileStats.map((stat, i) => (
                <div
                  key={i}
                  className="bg-white/10 backdrop-blur-md rounded-2xl py-4 border border-white/10"
                >
                  <p className="text-xl font-black">{stat.value}</p>
                  <p className="text-[10px] uppercase font-black text-indigo-200 tracking-widest">
                    {stat.label}
                  </p>
                </div>
              ))}
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <section
            className={`
              p-10 rounded-[40px] shadow-sm border
              ${darkMode ? "bg-[#1E0B3B] border-white/5" : "bg-white border-slate-100"}
            `}
          >
            <h3 className="text-lg font-black mb-8">Personal Information</h3>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 font-bold">Toggle theme appearance</p>
                </div>
              </div>
      ...
      {showLogoutConfirm && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div
            className={`
              relative w-full max-w-sm rounded-[3rem] p-10
              shadow-2xl border text-center transition-all transform
            ...
            <div className="flex flex-col gap-3">
              ...
              <button
                ...
                className={`
                  ...
                  active:scale-95 text-sm uppercase tracking-widest
